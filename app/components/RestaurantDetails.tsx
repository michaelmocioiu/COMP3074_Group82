    ...
    return (
      ...
      <View style={g_style.container}>
        ...
        <div style={style.row}>
          ...
          <TouchableOpacity onPress={() => { console.log(`route to map with address: ${restaurant.address}`); }}>
            <Ionicons name="map-outline" size={20} style={style.icon} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => { console.log(`route to directions with address: ${restaurant.address}`); }}>
            <Ionicons name="pin-outline" size={20} style={style.icon} />
          </TouchableOpacity>
        </div>

        <div style={style.row}>
          {restaurant.tags.map((tag, index) => (
            <TouchableOpacity key={index} style={style.restaurantTag}>{tag}</TouchableOpacity>
          ))}
        </div>
